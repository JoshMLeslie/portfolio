...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["projects-projects-module-ngfactory"], {
  ...
  /***/
  function srcAppSharedProjectTileProjectTileModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProjecTileModule", function () {
      return ProjecTileModule;
    });

    var ProjecTileModule = function ProjecTileModule() {
      _classCallCheck(this, ProjecTileModule);
    };
    /***/
  ...
  /***/
  function srcAppSplitScreenWebProjectsProjectsModuleNgfactoryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WebProjectsModuleNgFactory", function () {
      return WebProjectsModuleNgFactory;
    });
    /* harmony import */
    ...
    var _projects_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./projects.module */
    ...
    var _song_to_piano_song_to_piano_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./song-to-piano/song-to-piano.service */
    "./src/app/split-screen/web/projects/song-to-piano/song-to-piano.service.ts");
    /* harmony import */


    var _shared_utilities_window_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ../../../shared/utilities/window.service */
    "./src/app/shared/utilities/window.service.ts");
    /* harmony import */


    var _song_to_piano_note_generator_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./song-to-piano/note-generator.service */
    ...
    var _projects_routing__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./projects.routing */
    ...
    var _shared_utilities_core_module__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(
    /*! ../../../shared/utilities/core.module */
    "./src/app/shared/utilities/core.module.ts");
    /* harmony import */


    var _shared_project_tile_project_tile_module__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(
    /*! ../../../shared/project-tile/project-tile.module */
    "./src/app/shared/project-tile/project-tile.module.ts");
    /* harmony import */


    var _song_to_piano_song_to_piano_module__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(
    /*! ./song-to-piano/song-to-piano.module */
    "./src/app/split-screen/web/projects/song-to-piano/song-to-piano.module.ts");
    /* harmony import */


    var _xr_xr_module__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(
    /*! ./xr/xr.module */
    ...
    var WebProjectsModuleNgFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵcmf"](_projects_module__WEBPACK_IMPORTED_MODULE_1__["WebProjectsModule"], [], function (_l) {
  ...
  /***/
  function srcAppSplitScreenWebProjectsProjectsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WebProjectsModule", function () {
      return WebProjectsModule;
    });

    var WebProjectsModule = function WebProjectsModule() {
      _classCallCheck(this, WebProjectsModule);
    };
    /***/
  ...
  /***/
  function srcAppSplitScreenWebProjectsProjectsRoutingTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WebProjectsRoutingModule", function () {
      return WebProjectsRoutingModule;
    });
    /* harmony import */
    ...
    var WebProjectsRoutingModule = function WebProjectsRoutingModule() {
      _classCallCheck(this, WebProjectsRoutingModule);
    };
    /***/
  ...
  /***/
  function srcAppSplitScreenWebProjectsSongToPianoNoteGeneratorServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NoteGeneratorService", function () {
    ...
    var _piano_keys_config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./piano-keys.config */
    ...
    var NoteGeneratorService = /*#__PURE__*/function () {
      function NoteGeneratorService() {
        _classCallCheck(this, NoteGeneratorService);
        ...
        this.noteList$ = this._noteList.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["scan"])(function (acc, val) {
          return acc += val + ' ';
      ...
      _createClass(NoteGeneratorService, [{
        key: "toggleLiveInput",
        value: function toggleLiveInput() {
          ...
          navigator.mediaDevices.getUserMedia(audioOptions).then(function (stream) {
            // Create an AudioNode from the stream.
            _this.mediaStreamSource = _this.audioContext.createMediaStreamSource(stream); // Connect it to the destination.
        ...
        key: "autoCorrelate",
        value: function autoCorrelate() {
          var sampleRate = this.audioContext.sampleRate;
          var SIZE = this.buflen;
          var MAX_SAMPLES = Math.floor(this.buflen / 2);
          var correlations = {};
          var bestOffset = -1;
          ...
          rms = Math.sqrt(rms / SIZE); // not enough signal
          ...
          for (var offset = this.MIN_SAMPLES; offset < MAX_SAMPLES; offset++) {
            ...
            for (var _i = 0; _i < MAX_SAMPLES; _i++) {
              correlation += Math.abs(this.buf[_i] - this.buf[_i + offset]);
            }
        ...
        value: function updatePitch() {
          ...
          var pitch = this.autoCorrelate();

          if (pitch !== -1) {
            this.printNote(pitch);
          }

          Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["timer"])(this.resolution).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(1)).subscribe(function () {
            return _this2.updatePitch();
          });
        }
      }, {
        key: "printNote",
        value: function printNote(pitch) {
          var pianoKey = Math.floor(12 * Math.log2(pitch / 440) + 49);
          var noteEl = _piano_keys_config__WEBPACK_IMPORTED_MODULE_2__["PIANO_KEYS"][pianoKey];
    ...
    NoteGeneratorService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjectable"]({
      factory: function NoteGeneratorService_Factory() {
        return new NoteGeneratorService();
      },
      token: NoteGeneratorService,
      providedIn: "root"
    });
    /***/
  },
  ...
  /***/
  function srcAppSplitScreenWebProjectsSongToPianoPianoKeysConfigTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PIANO_KEYS", function () {
      return PIANO_KEYS;
    });
  ...
  /***/
  function srcAppSplitScreenWebProjectsSongToPianoSongToPianoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SongToPianoModule", function () {
      return SongToPianoModule;
    });

    var SongToPianoModule = function SongToPianoModule() {
      _classCallCheck(this, SongToPianoModule);
    };
    /***/
  ...
  /***/
  function srcAppSplitScreenWebProjectsSongToPianoSongToPianoServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SongToPianoService", function () {
      return SongToPianoService;
    });
    /* harmony import */


    var _shared_utilities_window_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ../../../../shared/utilities/window.service */
    "./src/app/shared/utilities/window.service.ts");
    /* harmony import */
    ...
    var SongToPianoService = /*#__PURE__*/function () {
      function SongToPianoService(window) {
        _classCallCheck(this, SongToPianoService);
      ...
      _createClass(SongToPianoService, [{
        key: "webaudioToolingObj",
        value: function webaudioToolingObj() {
          var _this3 = this;

          console.log('audio is starting up ...');
          var getUserMedia = this.navigator.mediaDevices.getUserMedia;

          if (getUserMedia) {
            var opts = {
              audio: true
            };
            this.navigator.mediaDevices.getUserMedia(opts).then(function (stream) {
              console.log(stream);

              _this3.startMicrophone(stream);
            })["catch"](function (e) {
              console.error(e);
        ...
        key: "startMicrophone",
        value: function startMicrophone(stream) {
          var _this4 = this;
          ...
          this.microphoneStream.connect(this.scriptProcessorNode); // --- setup FFT
          ...
          this.scriptProcessorFFTNode.onaudioprocess = function () {
            // get the average for the first channel
            var arr = new Uint8Array(_this4.analyserNode.frequencyBinCount);

            _this4.analyserNode.getByteFrequencyData(arr);
          };
        }
      }]);
    ...
    SongToPianoService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
      factory: function SongToPianoService_Factory() {
        return new SongToPianoService(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_shared_utilities_window_service__WEBPACK_IMPORTED_MODULE_0__["WindowService"]));
      },
      token: SongToPianoService,
      providedIn: "root"
    });
    /***/
  },
  ...
  /***/
  function srcAppSplitScreenWebProjectsXrXrModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "XRModule", function () {
      return XRModule;
    });

    var XRModule = function XRModule() {
      _classCallCheck(this, XRModule);
    };
    /***/

  }
}]);
//# sourceMappingURL=projects-projects-module-ngfactory-es5.js.map